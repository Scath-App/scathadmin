...
import { getOpportunityAnalytics, downloadOpportunitiesReportPdf, AdminAnalyticsWindow } from "@/lib/analyticsService";
...
export default function OpportunitiesAnalyticsPage() {
  ...
  const handleExport = async () => {
    setIsExporting(true);
    try {
      await downloadOpportunitiesReportPdf(queryParam);
    } finally {
